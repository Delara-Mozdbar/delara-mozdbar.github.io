...
Personal ecosystem built on a **Linear-inspired dark architecture**:

| Token | Value | Role |
|-------|-------|------|
| Void | `#0f0f11` | Page background — foundational depth |
| Surface | `#1a1a22` | Cards & section containers |
| Elevated | `#2e2e38` | Hover states & borders |
| Primary | `#e2e0dd` | Brand typography — warm neutral |
| Muted | `#6b6a72` | Secondary text — low noise |
| Accent | `#c9a96e` | Interaction focal points — Warm Gold |
...
- Participated in early-stage ideation alongside the team during the platform's initial planning phase
...
When not deep in user flows or system tokens, I find structural balance in Persian literature — discovering in Rumi's poetry the same geometry that governs great design: rhythm, restraint, and meaning in every space.

---

<p align="center">
  <a href="https://delara-mozdbar.github.io">Portfolio</a> &nbsp;·&nbsp;
  <a href="https://www.linkedin.com/in/delara-mozdbar/">LinkedIn</a> &nbsp;·&nbsp;
  <a href="mailto:delara.mozdbar@gmail.com">Email</a>
</p>
